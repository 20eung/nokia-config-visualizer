...
│  For Tools:   JSON API / Zabbix LLD         │ ← Feature 1 (v4.8.1)
│  For AI:      MCP Server / RAG Knowledge    │ ← Feature 2 & 3 (v4.8.1)
└─────────────────────────────────────────────┘
```
...
### Phase 1: JSON REST API (v4.8.1 — Feature 1)
...
### Phase 2: MCP Server (v4.8.1 — Feature 2)
...
### Phase 3: RAG Indexing (v4.8.1 — Feature 3)
- [ ] `npm install vectra`
